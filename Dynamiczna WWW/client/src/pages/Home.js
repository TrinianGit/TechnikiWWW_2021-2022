    ...
    <div>
      <nav className="navbar navbar-expand-lg sticky-top pt-2 Dark">
        <div className="Wrapper container-fluid flex-nowrap flex-lg-wrap justify-content-evenly">
          ...
          <Formik validationSchema={validationSchema2} onSubmit={(data) => {window.location.href = `/user/${data.User}`}} initialValues={initialValues2}>
            <Form role="search ms-lg-0">
              <Field className="form-control" name='User' placeholder="Wyszukaj" aria-label="Wyszukaj" />
            </Form>
          </Formik>
        ...
        <div className="Background bg-image p-5 text-center text-black">
          <h1 className="mb-3 h2 fs-1 fw-bold">Witamy na stronie głównej projektu "Magic Page"!</h1>
        ...
        <div className="Newsletter Dark container-fluid py-4">
          <div className="row align-items-center">
            <h1 className="fw-bold text-center col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">Dołącz do Newslettera!</h1>
            <form className="text-center col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
              <input type="email" placeholder="Podaj Email..." required />
              <button type="submit" className="Button text-center">Dołącz</button>
            </form>
          </div>
        </div>
        <div className="Webnote Light">
          <h1 className="text-center py-5">Jedna strona, wiele mozliwosci!</h1>
          <div className="container">
            <div className="row text-center">
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 px-5">
                <img className="Photo img-fluid py-2" src="https://cdn-icons-png.flaticon.com/512/2037/2037075.png" />
                <h2>Wieloplatformowość</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus mi augue, viverra sit amet ultricies</p>
              </div>
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 px-5">
                <img className="Photo img-fluid py-2" src="https://cdn-icons-png.flaticon.com/512/2362/2362103.png" />
        ...
        <div className="Dark text-center">
          <h1 className="py-5">Obejrzyj nasz filmik promocyjny!</h1>
          <div className="container pb-5">
            <div className="ratio ratio-16x9">
              <iframe src="https://www.youtube.com/embed/opNgrPv3Qw8" title="YouTube video" allowFullScreen />
            </div>
          </div>
        </div>
        <div className="Light py-5">
          <div className="container">
            <div className="row text-center">
              <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 px-5">
                <img className="Photo img-fluid py-2" src="https://cdn-icons-png.flaticon.com/512/4371/4371287.png" />
                <h2>Niezawodność</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus mi augue, viverra sit amet ultricies</p>
              </div>
              <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 px-5">
                <img className="Photo img-fluid py-2" src="https://cdn-icons-png.flaticon.com/512/3442/3442327.png" />
                <h2>Doświadczenie</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus mi augue, viverra sit amet ultricies</p>
              </div>
              <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 px-5">
                <img className="Photo img-fluid py-2" src="https://cdn-icons-png.flaticon.com/512/1568/1568482.png" />
                <h2>Prekursorzy rynku</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus mi augue, viverra sit amet ultricies</p>
              </div>
            </div>
          </div>
